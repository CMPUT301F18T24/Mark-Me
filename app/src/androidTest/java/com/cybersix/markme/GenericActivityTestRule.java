...
public class GenericActivityTestRule<T extends Activity> extends ActivityTestRule {
     ...
     */
    public GenericActivityTestRule(Class<T> activityClass) {
     ...
     * used by subclasses of GenericActivityTestRule to get notified when the activity is created and
